...
<a href="home.php"><button style="height: 40px; width: 30%; background-color:#00cc66;cursor: pointer;
	...
	<fieldset class="fieldset1">
		<legend>customer create account</legend> 
		<form method="POST" action="customer_create_account.php">
			...
			<div class="field_1">
   		    ...
   		    <div class="field_7">
   			<b>you have account as an customer</b>  <a href="customer_login.php">login up</a>
   		</div>
		</form>
	</fieldset>
	</center>
