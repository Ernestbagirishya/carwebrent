...
<div class="header_div" style="display: flex; align-items: center; justify-content: space-between;">
	<div class="header_logo"><b>car rent: <?php echo $_SESSION['user1']; ?></b></div>
	<div class="header_nav" style="">
		<a href="customer_home.php"><div class="header_nav_admin_home"><b>Home</b></div></a>
		<a href="customer_car_view.php"><div class="header_nav_add_car"><b>view cars</b></div></a>
		<a href="customer_change_password.php"><div class="header_nav_car_list">
            <b>change password</b></div></a>
